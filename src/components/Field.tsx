...
/** Anillo de foco consistente para toda la app: mismo acento (arcilla) que el resto de
 * elementos interactivos de marca, para no introducir un tercer color "vivo". */
export const focusRing =
  "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent-clay)]";
...
export const inputClass = `w-full rounded-xl border border-[var(--border)] bg-[var(--surface-1)] px-3 py-2 text-base sm:text-sm text-[var(--text-primary)] transition-colors focus-visible:border-[var(--accent-clay)] ${focusRing}`;
